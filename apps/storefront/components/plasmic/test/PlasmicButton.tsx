...
import sty from "./PlasmicButton.module.css"; // plasmic-import: vT52ykebc1Op/css
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames("all", sty.freeBox__rpoK, {
          [sty.freeBoxcolor_neutral__rpoKCuCM]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__rpoKH32UQmNYz]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxcolor_white__rpoKrhqwz]: hasVariant(
            $state,
            "color",
            "white"
          ),
          [sty.freeBoxroundedFull__rpoKd3Kn]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__rpoKq4EEg]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__rpoKfmJa]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__rpoK2K3Bs]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__rpoK4MgMy]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__rpoKqmNYz]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames("all", sty.freeBox__maqzY, {
            [sty.freeBoxcolor_neutral__maqzYCuCM]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__maqzYCuCMCtBr9]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__maqzY3XZk]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__maqzYq4EEg]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__maqzY2K3Bs]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__maqzY4MgMy]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__maqzYqmNYz]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__eogjo)}
                role={"img"}
              />
            ),
        ...
        {renderPlasmicSlot({
          defaultContents: (
            <div className={classNames("all", "__wab_text", sty.text__cl3He)}>
              {"Text"}
            </div>
          ),
          value: args.label,
        ...
        <div
          className={classNames("all", sty.freeBox__fwrF, {
            [sty.freeBoxiconEnd__fwrFsMpav]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__fwrFq4EEg]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__fwrF2K3Bs]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__fwrF4MgMy]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDown2Icon
                className={classNames("all", sty.svg__v8XmS)}
                role={"img"}
              />
            ),
